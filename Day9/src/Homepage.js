...
const ConcertSearch = () => {
  ...
  return (
    ...
    <input id="slide-sidebar" type="checkbox" role="button" />
        ...
        <p class="details">Payment</p>
        <p class="details">Notifications</p>
        <Link to="/Admin"><p class="details">Admin</p></Link>

        <p class="details">Help Centre?</p>
        </div>
    <div class="portfolio">
  ...
  <div class="bottom-links">
    ...
    <ul>
       <li> <Link to="/Terms"> <a class="bt btleft" href="#">Terms and Conditions</a></Link></li>
        <li> <a class="bt btleft" href="#">Privacy Policy</a>

        </li>
        <li> <a class="bt btleft" href="#">FAQ</a>

        </li>
        <li> <a class="bt btleft" href="#">Contact  </a>

        </li>
    </ul>
    <div class="links2">
    <ul class="socialmedia">
        <li><a class="bt btleft" href="#"><img src="https://upload.wikimedia.org/wikipedia/commons/thumb/a/a5/Instagram_icon.png/2048px-Instagram_icon.png" class="insta"></img></a>

        </li>
        <li> <a class="bt btleft" href="#"><img src="https://upload.wikimedia.org/wikipedia/commons/thumb/b/b8/2021_Facebook_icon.svg/2048px-2021_Facebook_icon.svg.png" class="fb"></img></a>

        </li>
        <li> <a class="bt btleft" href="#"><img src="https://cdn4.iconfinder.com/data/icons/social-media-icons-the-circle-set/48/twitter_circle-512.png" class="twit"></img></a>
