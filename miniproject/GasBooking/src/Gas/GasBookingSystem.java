...
public class GasBookingSystem {
    private static Map<String, Person> consumers = new HashMap<>();
    ...
    private static void registerNewConsumer() {
        ...
        Person newConsumer = new Consumer(consumerID, name, address, phone, gasName, usageDetails);
        ...
        try {
            DatabaseManager.insertConsumer((Consumer) newConsumer); // Cast to Consumer
            System.out.println("Consumer registered successfully!");
            System.out.println("Registered Consumer Details:");
            System.out.println(newConsumer);
        } catch (SQLException e) {
