...
const MovieSeating = () => {
  ...
  const bookedSeats = ['A3', 'B2', 'C1','D4','E3','F5'];
  ...
  return (
    ...
    <div>
      ...
      <div class="alignment">
        ...
        <h3>Total Amount: {totalAmount}</h3><Link to="/Payment"><button class="paynow">Pay Now</button></Link>
      </div>
        </center>
      <div>
        <button class="calculateamount"onClick={calculateAmount} disabled={seats.length === 0}>
          Calculate Amount
        </button>
      </div>
